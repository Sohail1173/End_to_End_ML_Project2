...
class DataTransformation:
    def __init__(
        ...
        self.data_ingestionn_artifact=data_ingestion_artifact
    ...
    def data_loader(
        ...
        try:
            ...
            train_data: Dataset = ImageFolder(
                os.path.join(self.data_ingestionn_artifact.train_file_path),
                transform=train_transform,
            )

            test_data: Dataset = ImageFolder(
                os.path.join(self.data_ingestionn_artifact.test_file_path),
